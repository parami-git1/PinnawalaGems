...
function App() {
  ...
  const handleCatSubmit = async (e) => {
    ...
    if (!catFormData.title || !catFormData.mainImage) {
      alert("Please provide the Gem Type Name and an Icon Image!");
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-blue-950 flex flex-col">
      ...
      {/* ---------------- MAIN CONTENT (UNIFIED SIDEBAR + COVER BANNER LAYOUT FOR BOTH CUSTOMERS & ADMINS) ---------------- */}
      <main className="flex-1 w-full max-w-[1400px] mx-auto pt-44 px-4 md:px-8 pb-20">
        
        <div className="flex gap-6 w-full">
          
          {/* LEFT SIDEBAR (VISIBLE TO BOTH) */}
            ...
            <ul className="space-y-1.5">
              ...
              >
                <div className="flex items-center gap-3 overflow-hidden flex-1 mr-2">
                  ...
                  <span className="text-[11px] uppercase tracking-wider">All Gem Types</span>
                </div>
          ...
          <section className="flex-1 flex flex-col min-w-0">
            ...
            {/* EDIT ALL GEMS COVER MODAL (ADMIN ONLY) */}
